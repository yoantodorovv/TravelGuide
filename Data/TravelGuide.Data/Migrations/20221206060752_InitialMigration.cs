    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserDiscount", x => new { x.DiscountsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserDiscount_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUserDiscount_Discounts_DiscountsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hotels_Addresses_AdressId",
                        column: x => x.AdressId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DicountId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HotelReservations_Discounts_DicountId",
                        column: x => x.DicountId,
                        principalTable: "Discounts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelWorkingHours", x => new { x.HotelsId, x.WorkingHoursId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HotelWorkingHours_WorkingHours_WorkingHoursId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RestaurantReservations_Discounts_DiscountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantWorkingHours", x => new { x.RestaurantsId, x.WorkingHoursId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RestaurantWorkingHours_WorkingHours_WorkingHoursId",
                        column: x => x.WorkingHoursId,
                        principalTable: "WorkingHours",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserDiscount_UsersId",
                table: "ApplicationUserDiscount",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelReservations_DicountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelReservations_IsDeleted",
                table: "HotelReservations",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelWorkingHours_WorkingHoursId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantReservations_DiscountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantWorkingHours_WorkingHoursId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingHours_IsDeleted",
                table: "WorkingHours",
                column: "IsDeleted");
        }
