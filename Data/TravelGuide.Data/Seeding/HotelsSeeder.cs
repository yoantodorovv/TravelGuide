    ...
    public class HotelsSeeder : ISeeder
    {
        ...
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            var hotels = new List<Hotel>
            {
                new Hotel()
                {
                    OwnerId = dbContext.Users.FirstOrDefault(x => x.Id.ToString() == "B7429C50-5F89-45B1-C3E8-08DAD0996F7F").Id,
                    ...
                    Rating = 4.5,
                    Address = dbContext.Addresses.FirstOrDefault(x => x.Id.ToString() == "9A7654C2-B5DA-4AC1-3585-08DAD0999973"),
